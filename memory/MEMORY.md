...
Last updated: 2026-03-31 (local LLM research + he→en evaluator normalization + mini present expansion)
...
- **Local LLM generation — RESEARCH IN PROGRESS (2026-03-31)**: Evaluating Dicta‑LM 3.0 (1.7B/12B/24B), Gemma 3 (1B/4B/12B/27B), and Tiny Aya (~3.3B) for offline Hebrew sentence generation. See `docs/LOCAL_LLM_RESEARCH.md`.
